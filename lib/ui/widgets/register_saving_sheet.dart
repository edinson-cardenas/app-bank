...
class _RegisterSavingSheetState extends State<RegisterSavingSheet> {
  ...
  String get _title {
    switch (widget.type) {
      ...
      case 'gasto': return 'Registrar gasto';
      case 'inversion': return 'Registrar inversión';
  ...
  Color get _primaryColor {
    switch (widget.type) {
      case 'ahorro': return Colors.green;
      case 'gasto': return Colors.redAccent;
      case 'inversion': return Colors.blueAccent;
  ...
  IconData get _icon {
    switch (widget.type) {
      case 'ahorro': return Icons.monetization_on_outlined;
      case 'gasto': return Icons.credit_card_outlined;
      case 'inversion': return Icons.bar_chart_rounded;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Icon(Icons.calendar_today_outlined, size: 20, color: _primaryColor),
  ...
  void _saveTransaction() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("${_title} guardado con éxito")));
      }
    } catch (e) {
      if (mounted) {
